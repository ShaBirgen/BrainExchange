...
let UserService = (() => {
    ...
    var UserService = _classThis = class {
        ...
        getOneUserDetails(id) {
            return this.http.get(`http://localhost:3000/users/getOneUser/${id}`, {
        ...
        updateUserDetails(user_Id, details) {
            return this.http.put(`http://localhost:3000/users/updateUser/${user_Id}`, details, {
                headers: new http_1.HttpHeaders({
                    'Content-type': 'application/json',
                    token: this.token,
                }),
        ...
        setRole(user_Id, Role) {
            return this.http.put(`http://localhost:3000/users/set-role/${user_Id}`, { Role });
        }
    };
